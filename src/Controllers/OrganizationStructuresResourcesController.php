 ...
 *  )
 */
class OrganizationStructuresResourcesController extends Controller
{
    protected $modelNamespace = 'SaltOrganization';

    /**
     * @OA\Get(
     *      path="/api/v1/organization_structures",
     ...
     *      @OA\Response(
     *          response="200",
     *          description="List of Organization Structures"
     *      ),
