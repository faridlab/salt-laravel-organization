...
/**
 * @OA\Info(
 *      title="Organization Industries Endpoint",
 *      version="1.0",
 *      @OA\Contact(
 *          name="Farid Hidayat",
 ...
 *  )
 */
class OrganizationIndustriesResourcesController extends Controller
{
    protected $modelNamespace = 'SaltOrganization';

    /**
     * @OA\Get(
     *      path="/api/v1/organization_industries",
     ...
     *      @OA\Response(
     *          response="200",
     *          description="List of Industry of Organization"
     *      ),
